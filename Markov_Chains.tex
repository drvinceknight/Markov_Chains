...
$$Q(t)=
\begin{pmatrix}
q_{00}(n)&q_{01}(n)&q_{02}(n)&\dots&q_{0j}(n)&\dots\\
q_{20}(n)&q_{11}(n)&q_{12}(n)&\dots&q_{1j}(n)&\dots\\
q_{20}(n)&q_{21}(n)&q_{22}(n)&\dots&q_{2j}(n)&\dots\\
\vdots&\vdots&\vdots&\vdots&\vdots&\vdots\\
q_{i0}(n)&q_{i1}(n)&q_{i2}(n)&\dots&q_{ij}(n)&\dots\\
\vdots&\vdots&\vdots&\vdots&\vdots&\vdots
\end{pmatrix}
$$
...
-3\pi_1+\pi_2+0\pi_3+2\pi_4=0\\
1\pi_1-5\pi_2+4\pi_3+0\pi_4=0\\
1\pi_1+3\pi_2-4\pi_3+0\pi_4=0\\
0\pi_1+0\pi_2+\pi_3-\pi_4=0\\
\end{cases}$$
Solving this gives:
$$\begin{cases}
\pi_1=c\\
